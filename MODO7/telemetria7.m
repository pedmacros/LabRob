...
subplot(2,1,1);
plot(tiempo,tel(:,2), tiempo,tel(:,3), tiempo,tel(:,4), tiempo,tel(:,5), tiempo,tel(:,6), tiempo,tel(:,7),'*-');
xlabel('Tiempo (ms)');
title('Sensores');
legend('Distancia Dch (cm)','Distancia Izq (cm)','Velocidad Izq (rad/s)','Velocidad Dch (rad/s)','Referencia (rad/s)','Ángulo(rad)');
grid;
